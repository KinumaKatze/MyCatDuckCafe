...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$Model(10)(10)(true)(
			{active: true, conversation: 0, hidden: true, id: 0, index: 0, modal: false, name: '/public/images/Random_Person.png', nextText: 'Next Text', randomString: $elm$core$Maybe$Nothing, spokenText: ''})(
			{active: true, conversation: 0, hidden: true, id: 1, index: 0, modal: false, name: '/public/images/Random_Person.png', nextText: 'Next Text', randomString: $elm$core$Maybe$Nothing, spokenText: ''})(
			{active: true, conversation: 0, hidden: true, id: 2, index: 0, modal: false, name: '/public/images/Random_Person.png', nextText: 'Next Text', randomString: $elm$core$Maybe$Nothing, spokenText: ''})(
			{active: true, conversation: 0, hidden: true, id: 3, index: 0, modal: false, name: '/public/images/Random_Person.png', nextText: 'Next Text', randomString: $elm$core$Maybe$Nothing, spokenText: ''})(
			{active: true, conversation: 0, hidden: true, id: 4, index: 0, modal: false, name: '/public/images/Random_Person.png', nextText: 'Next Text', randomString: $elm$core$Maybe$Nothing, spokenText: ''})(0)(
			_List_fromArray(
			...
			switch (msg.$) {
				...
				case 'RemoveNPC':
					...
					var seatClear = function (a) {
						return _Utils_update(
							a,
							{conversation: 0, hidden: true, index: 0, modal: false, name: '/public/images/Random_Person.png', nextText: 'Next Text', spokenText: ''});
					};
					var _v16 = seat.id;
					switch (_v16) {
						case 0:
